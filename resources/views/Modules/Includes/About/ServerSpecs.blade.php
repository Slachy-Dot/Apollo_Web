  ...
  <div class="mx-4 my-2 font-mono font-medium text-indigo-200 text-md"> 
    <h2 class="text-xl font-extrabold text-center text-indigo-300 my-card-title">Server Hardware</h2>

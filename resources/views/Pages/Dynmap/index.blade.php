...
<html lang="en">
  <head>
    ...
    <title>World of Apollo - LiveAtlas</title>
        ...
        window.liveAtlasConfig = {
          servers: {
            survival: {
              ...
              dynmap: {
                configuration:
                  "./Files/Survival-10/standalone/dynmap_config.json?_={timestamp}",
                update:
                  "./Files/Survival-10/standalone/dynmap_{world}.json?_={timestamp}",
                sendmessage: "./Files/Survival-10/standalone/sendmessage.php",
                login: "./Files/Survival-10/standalone/login.php",
                register: "./Files/Survival-10/standalone/register.php",
                tiles: "./Files/Survival-10/tiles/",
                markers: "./Files/Survival-10/tiles/",
              },
            },            
            survival_classic: {
              label: "Survival-9",
              dynmap: {
                configuration:
                  "./Files/Survival/standalone/dynmap_config.json?_={timestamp}",
                update:
                  "./Files/Survival/standalone/dynmap_{world}.json?_={timestamp}",
                sendmessage: "./Files/Survival/standalone/sendmessage.php",
                login: "./Files/Survival/standalone/login.php",
                register: "./Files/Survival/standalone/register.php",
                tiles: "./Files/Survival/tiles/",
                markers: "./Files/Survival/tiles/",
              },
            },
            creative: {
              label: "Creative",
              dynmap: {
                configuration:
                  "Files/Creative/standalone/dynmap_config.json?_={timestamp}",
                update:
                  "Files/Creative/standalone/dynmap_{world}.json?_={timestamp}",
                sendmessage: "Files/Creative/standalone/sendmessage.php",
                login: "Files/Creative/standalone/login.php",
                register: "Files/Creative/standalone/register.php",
                tiles: "Files/Creative/tiles/",
                markers: "Files/Creative/tiles/",
              },
            },
            lobby: {
              label: "Lobby",
              dynmap: {
                configuration:
                  "./Files/Lobby/standalone/dynmap_config.json?_={timestamp}",
                update:
                  "./Files/Lobby/standalone/dynmap_{world}.json?_={timestamp}",
                sendmessage: "./Files/Lobby/standalone/sendmessage.php",
                login: "./Files/Lobby/standalone/login.php",
                register: "./Files/Lobby/standalone/register.php",
                tiles: "./Files/Lobby/tiles/",
                markers: "./Files/Lobby/tiles/",                
              },
            },
          },
          messages: {
    ...
    <script type="module" crossorigin src="./live-atlas/assets/index.0da92764.js"></script>
    <link rel="modulepreload" href="./live-atlas/assets/vendor.5f1f20ce.js">
    <link rel="stylesheet" href="./live-atlas/assets/index.6def8a98.css">
  </head>
  <body>
    <div id="splash">
